...
public class Routes {
    ...
    // circulars
    public static final String getCirculars = "http://192.168.0.5:3000/api/circulars/";
    ...
    public static final String requestHistory = "http://192.168.0.5:3000/api/requests_history/";
